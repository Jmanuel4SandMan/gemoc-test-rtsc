...
public class StepsPackageImpl extends EPackageImpl implements StepsPackage {
	...
	public void initializePackageContents() {
		...
		rtsc_Realtimestatechart_InitializeEClass.getESuperTypes().add(this.getSpecificStep());
		rtsc_Realtimestatechart_InitializeEClass.getESuperTypes().add(theTracePackage.getSmallStep());
		...
		EGenericType g2 = createEGenericType(this.getRtsc_Realtimestatechart_Step_AbstractSubStep());
