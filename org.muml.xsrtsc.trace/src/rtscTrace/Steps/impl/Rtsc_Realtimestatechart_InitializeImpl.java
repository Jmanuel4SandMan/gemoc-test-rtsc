...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rtsc Realtimestatechart Initialize</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link rtscTrace.Steps.impl.Rtsc_Realtimestatechart_InitializeImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link rtscTrace.Steps.impl.Rtsc_Realtimestatechart_InitializeImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link rtscTrace.Steps.impl.Rtsc_Realtimestatechart_InitializeImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Rtsc_Realtimestatechart_InitializeImpl extends StepImpl implements Rtsc_Realtimestatechart_Initialize {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Rtsc_Realtimestatechart_Initialize_AbstractSubStep> subSteps;
	 ...
	 * @generated
	 */
	protected Rtsc_Realtimestatechart_InitializeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.RTSC_REALTIMESTATECHART_INITIALIZE;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public EList<Rtsc_Realtimestatechart_Initialize_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<Rtsc_Realtimestatechart_Initialize_AbstractSubStep>(Rtsc_Realtimestatechart_Initialize_AbstractSubStep.class, this, StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__SUB_STEPS);
		}
		return subSteps;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__SUB_STEPS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends Rtsc_Realtimestatechart_Initialize_AbstractSubStep>)newValue);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__SUB_STEPS: return TracePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case TracePackage.BIG_STEP__SUB_STEPS: return StepsPackage.RTSC_REALTIMESTATECHART_INITIALIZE__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
...
} //Rtsc_Realtimestatechart_InitializeImpl
