...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rtsc Realtimestatechart Init RTSC</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link rtscTrace.Steps.impl.Rtsc_Realtimestatechart_InitRTSCImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link rtscTrace.Steps.impl.Rtsc_Realtimestatechart_InitRTSCImpl#getStartingState <em>Starting State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Rtsc_Realtimestatechart_InitRTSCImpl extends StepImpl implements Rtsc_Realtimestatechart_InitRTSC {
	/**
	 ...
	 * @generated
	 */
	protected Rtsc_Realtimestatechart_InitRTSCImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.RTSC_REALTIMESTATECHART_INIT_RTSC;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.RTSC_REALTIMESTATECHART_INIT_RTSC__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.RTSC_REALTIMESTATECHART_INIT_RTSC__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.RTSC_REALTIMESTATECHART_INIT_RTSC__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.RTSC_REALTIMESTATECHART_INIT_RTSC__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.RTSC_REALTIMESTATECHART_INIT_RTSC__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.RTSC_REALTIMESTATECHART_INIT_RTSC__STARTING_STATE, newStartingState, newStartingState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.RTSC_REALTIMESTATECHART_INIT_RTSC__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.RTSC_REALTIMESTATECHART_INIT_RTSC__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
...
} //Rtsc_Realtimestatechart_InitRTSCImpl
