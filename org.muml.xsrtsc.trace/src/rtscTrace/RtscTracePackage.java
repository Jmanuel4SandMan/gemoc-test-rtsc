...
public interface RtscTracePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SPECIFIC_TRACE__RTSC_REALTIMESTATECHART_INITIALIZE_SEQUENCE = TracePackage.TRACE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SPECIFIC_TRACE__RTSC_REALTIMESTATECHART_STEP_SEQUENCE = TracePackage.TRACE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SPECIFIC_TRACE__RTSC_TRANSITION_CAN_FIRE_SEQUENCE = TracePackage.TRACE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SPECIFIC_TRACE__RTSC_TRANSITION_FIRE_SEQUENCE = TracePackage.TRACE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int SPECIFIC_TRACE__RTSC_TRACED_REALTIMESTATECHARTS = TracePackage.TRACE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int SPECIFIC_TRACE__RTSC_TRACED_STATES = TracePackage.TRACE_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int SPECIFIC_TRACE__RTSC_TRACED_TRANSITIONS = TracePackage.TRACE_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int SPECIFIC_TRACE__RTSC_TRACED_VERTEXS = TracePackage.TRACE_FEATURE_COUNT + 7;
