...
public class RtscPackageImpl extends EPackageImpl implements RtscPackage {
	 ...
	 * @see org.muml.seq.xsrtsc.xsrtsc.rtsc.RtscPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getRealtimestatechart_InitialState() {
	 ...
	 * @generated
	 */
	public EReference getState_OwningRTSC() {
	 ...
	 * @generated
	 */
	public EReference getSystem_Statecharts() {
	 ...
	 * @generated
	 */
	public EReference getSystem_Protocol() {
	 ...
	 * @generated
	 */
	public EReference getSystem_MessageTypeRepo() {
	...
	public void createPackageContents() {
		...
		createEReference(systemEClass, SYSTEM__STATECHARTS);
		createEReference(systemEClass, SYSTEM__PROTOCOL);
		createEReference(systemEClass, SYSTEM__MESSAGE_TYPE_REPO);
	...
	public void initializePackageContents() {
		...
		addEOperation(stateEClass, null, "entry", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(stateEClass, null, "exit", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(clockEClass, null, "reset", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(messageBufferEClass, null, "addMessage", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(coordinationProtocolEClass, null, "main", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(systemEClass, org.muml.seq.xsrtsc.xsrtsc.rtsc.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_Statecharts(), this.getRealtimestatechart(), null, "statecharts", null, 0, -1, org.muml.seq.xsrtsc.xsrtsc.rtsc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Protocol(), this.getCoordinationProtocol(), null, "protocol", null, 0, -1, org.muml.seq.xsrtsc.xsrtsc.rtsc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_MessageTypeRepo(), this.getMessageTypeRepository(), null, "messageTypeRepo", null, 1, 1, org.muml.seq.xsrtsc.xsrtsc.rtsc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(eventEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(messageEventEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(clockResetEventEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(variableAssignmentEventEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (realtimestatechartEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (realtimestatechartEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (clockEClass.getEOperations().get(2), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (messageBufferEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (messageBufferEClass.getEOperations().get(2), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		...
		addAnnotation
		  (eventEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (messageEventEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (clockResetEventEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (variableAssignmentEventEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
