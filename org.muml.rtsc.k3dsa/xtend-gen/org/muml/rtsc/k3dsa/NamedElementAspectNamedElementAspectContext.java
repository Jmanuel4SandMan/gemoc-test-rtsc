...
import org.muml.rtsc.k3dsa.NamedElementAspectNamedElementAspectProperties;
...
public class NamedElementAspectNamedElementAspectContext {
  ...
  public static NamedElementAspectNamedElementAspectProperties getSelf(final NamedElement _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new org.muml.rtsc.k3dsa.NamedElementAspectNamedElementAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<NamedElement, NamedElementAspectNamedElementAspectProperties> map = new java.util.WeakHashMap<org.muml.rtsc.NamedElement, org.muml.rtsc.k3dsa.NamedElementAspectNamedElementAspectProperties>();
