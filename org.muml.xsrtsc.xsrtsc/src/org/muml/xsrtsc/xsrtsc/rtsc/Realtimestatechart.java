 ...
 *   <li>{@link org.muml.xsrtsc.xsrtsc.rtsc.Realtimestatechart#getVariables <em>Variables</em>}</li>
 *   <li>{@link org.muml.xsrtsc.xsrtsc.rtsc.Realtimestatechart#getClocks <em>Clocks</em>}</li>
...
public interface Realtimestatechart extends Behavior, NamedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.muml.xsrtsc.xsrtsc.rtsc.Transition#getStatechart <em>Statechart</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * The list contents are of type {@link org.muml.xsrtsc.xsrtsc.rtsc.Variable}.
	 * It is bidirectional and its opposite is '{@link org.muml.xsrtsc.xsrtsc.rtsc.Variable#getStatechart <em>Statechart</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.muml.xsrtsc.xsrtsc.rtsc.RtscPackage#getRealtimestatechart_Variables()
	 ...
	 * The list contents are of type {@link org.muml.xsrtsc.xsrtsc.rtsc.Clock}.
	 * It is bidirectional and its opposite is '{@link org.muml.xsrtsc.xsrtsc.rtsc.Clock#getStatechart <em>Statechart</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.muml.xsrtsc.xsrtsc.rtsc.RtscPackage#getRealtimestatechart_Clocks()
