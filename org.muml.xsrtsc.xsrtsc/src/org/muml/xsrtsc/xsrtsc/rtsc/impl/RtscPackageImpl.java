...
public class RtscPackageImpl extends EPackageImpl implements RtscPackage {
	 ...
	 * @see org.muml.xsrtsc.xsrtsc.rtsc.RtscPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(systemEClass, org.muml.xsrtsc.xsrtsc.rtsc.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_Statecharts(), this.getRealtimestatechart(), null, "statecharts", null, 0, -1, org.muml.xsrtsc.xsrtsc.rtsc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Protocol(), this.getCoordinationProtocol(), null, "protocol", null, 0, -1, org.muml.xsrtsc.xsrtsc.rtsc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_MessageTypeRepo(), this.getMessageTypeRepository(), null, "messageTypeRepo", null, 1, 1, org.muml.xsrtsc.xsrtsc.rtsc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
