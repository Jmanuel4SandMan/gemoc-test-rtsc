...
public class RtscSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RtscPackage.SYSTEM: {
				org.muml.seq.xsrtsc.xsrtscmt.rtsc.System system = (org.muml.seq.xsrtsc.xsrtscmt.rtsc.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseSystem(org.muml.seq.xsrtsc.xsrtscmt.rtsc.System object) {
		return null;
	}
