...
/**
 * This is the item provider adapter for a {@link org.muml.xsrtsc.xsrtsc.rtsc.CoordinationProtocol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoordinationProtocolItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CoordinationProtocol_ports_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CoordinationProtocol_ports_feature", "_UI_CoordinationProtocol_type"),
				 RtscPackage.Literals.COORDINATION_PROTOCOL__PORTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RtscPackage.Literals.COORDINATION_PROTOCOL__CONNECTOR);
		}
