...
/**
 * This is the item provider adapter for a {@link org.muml.xsrtsc.xsrtsc.rtsc.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RtscPackage.Literals.VARIABLE__INITIAL_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addRuntimeValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_runtimeValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_runtimeValue_feature", "_UI_Variable_type"),
				 RtscPackage.Literals.VARIABLE__RUNTIME_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
