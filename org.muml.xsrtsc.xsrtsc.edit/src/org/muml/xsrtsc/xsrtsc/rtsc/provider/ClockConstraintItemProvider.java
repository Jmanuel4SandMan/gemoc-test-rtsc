...
/**
 * This is the item provider adapter for a {@link org.muml.xsrtsc.xsrtsc.rtsc.ClockConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClockConstraintItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RtscPackage.Literals.CLOCK_CONSTRAINT__CLOCK,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RtscPackage.Literals.CLOCK_CONSTRAINT__BOUND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_ClockConstraint_type") + " " + clockConstraint.getBound();
	}
