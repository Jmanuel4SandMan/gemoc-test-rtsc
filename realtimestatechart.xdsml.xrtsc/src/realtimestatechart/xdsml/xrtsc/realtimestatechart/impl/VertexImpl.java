 ...
 * </p>
 * <ul>
 *   <li>{@link realtimestatechart.xdsml.xrtsc.realtimestatechart.impl.VertexImpl#isActive <em>Active</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class VertexImpl extends EObjectImpl implements Vertex {
	...
	public void setActive(boolean newActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RealtimestatechartPackage.VERTEX__ACTIVE, oldActive, active));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RealtimestatechartPackage.VERTEX__ACTIVE:
				return isActive();
		}
